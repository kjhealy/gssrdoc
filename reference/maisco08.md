...
Question Respondent's mother's occupation, 2010 census, and 2008 ISCO
code
...
- `[1320]` manufacturing, mining, construction, and distribution
  managers
...
- `[3359]` regulatory government associate professionals not elsewhere
  classified
...
- `[3510]` information and communications technology operations and user
  support technicians
...
- `[7130]` painters, building structure cleaners and related trades
  workers
...
- `[7210]` sheet and structural metal workers, moulders and welders, and
  related workers
...
- `[7500]` food processing, wood working, garment and other craft and
...
- `[8130]` chemical and photographic products plant and machine
  operators
...
- `[8159]` textile, fur and leather products machine operators not
  elsewhere classified
