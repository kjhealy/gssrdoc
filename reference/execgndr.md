...
Question Please consider the following positions and select the options
that come closest to your own opinion.) Senior executive of a large
company
...
`execgndr`](https://gssdataexplorer.norc.org/variables/7785/vshow).
