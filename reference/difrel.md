...
Question All things considered, people belonging to different religions
cannot get along with each other when living close together.
...
`difrel`](https://gssdataexplorer.norc.org/variables/7283/vshow).
