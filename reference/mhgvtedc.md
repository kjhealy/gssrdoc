...
people with situations like (NAME). D. Provide financial help for
education if (NAME) can't afford it.
...
`mhgvtedc`](https://gssdataexplorer.norc.org/variables/3791/vshow).
