...
- `[1790]` leather tanning and finishing and other allied products
  manufacturing
...
- `[2870]` structural metals, and boiler, tank, and shipping container
  manufacturing
...
- `[3490]` electrical lighting and electrical equipment manufacturing,
...
- `[6670]` radio and television broadcasting and cable subscription
  programming
...
- `[6970]` securities, commodities, funds, trusts, and other financial
  investments
...
- `[7190]` commercial, industrial, and other intangible assets rental
  and leasing

- `[7270]` legal services

- `[7280]` accounting, tax preparation, bookkeeping, and payroll
  services
...
- `[7890]` other schools and instruction, and educational support
  services
...
- `[8560]` independent artists, performing arts, spectator sports, and
  related industries

- `[8570]` museums, art galleries, historical sites, and similar
  institutions
...
- `[8670]` recreational vehicle parks and camps, and rooming and
  boarding houses
...
- `[8870]` commercial and industrial machinery and equipment repair and
  maintenance
...
- `[9170]` civic, social, advocacy organizations, and grantmaking and
  giving services
