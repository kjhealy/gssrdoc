...
#'  |2021  |3987  |1                    |4                            |1               |1                                             |14                       |-         |4      |2             |4         |1              |3                                      |-                           |-      |1                                             |4      |1                   |1                     |-             |3              |-                          |4032  |
#'  |Total |30570 |16                   |9                            |8               |10                                            |27                       |4         |16     |8             |8         |10             |10                                     |1                           |4      |2                                             |16     |5                   |2                     |1             |3              |0                          |30730 |
#'
...
#' Counts by year: 
#'
#'  |year  |iap   |child, not specified |grandchild, great-grandchild |son-in-law, daughter-in-law |natural/biological child |niece or nephew |cousin |sibling-in-law |other relative (great-aunt, grandniece, etc.) |friend |stepchild |child of non-relative |parent |roommate, housemate |no answer |other non-relative (employee, boarder) |not available in this year |Total |
#'  |:-----|:-----|:--------------------|:----------------------------|:---------------------------|:------------------------|:---------------|:------|:--------------|:---------------------------------------------|:------|:---------|:---------------------|:------|:-------------------|:---------|:--------------------------------------|:--------------------------|:-----|
...
#'  |Total |30696 |3                    |3                            |2                           |5                        |2               |1      |1              |3                                             |2      |1         |1                     |5      |2                   |2         |1                                      |0                          |30730 |
#'
#' @source General Social Survey https://gss.norc.org
#' @family Household Members and Structure
#' @family Household
...
#' Counts by year: 
#'
#'  |year  |iap   |natural/biological child |niece or nephew |child of non-relative |no answer |grandchild, great-grandchild |child, not specified |not available in this year |Total |
#'  |:-----|:-----|:------------------------|:---------------|:---------------------|:---------|:----------------------------|:--------------------|:--------------------------|:-----|
#'  |2000  |2816  |1                        |-               |-                     |-         |-                            |-                    |-                          |2817  |
#'  |2002  |2765  |-                        |-               |-                     |-         |-                            |-                    |-                          |2765  |
#'  |2004  |2812  |-                        |-               |-                     |-         |-                            |-                    |-                          |2812  |
...
#'  |2018  |2348  |-                        |-               |-                     |-         |-                            |-                    |-                          |2348  |
#'  |2021  |4030  |-                        |-               |-                     |-         |2                            |-                    |-                          |4032  |
#'  |Total |30721 |1                        |1               |1                     |2         |3                            |1                    |0                          |30730 |
#'
#' @source General Social Survey https://gss.norc.org
#' @family Household Members and Structure
#' @family Household
...
#' Counts by year: 
#'
#'  |year  |iap   |niece or nephew |no answer |grandchild, great-grandchild |stepchild |not available in this year |Total |
#'  |:-----|:-----|:---------------|:---------|:----------------------------|:---------|:--------------------------|:-----|
#'  |2000  |2817  |-               |-         |-                            |-         |-                          |2817  |
#'  |2002  |2765  |-               |-         |-                            |-         |-                          |2765  |
#'  |2004  |2812  |-               |-         |-                            |-         |-                          |2812  |
