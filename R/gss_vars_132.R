...
#'  blkzone
#' 
#' Question 408. Here are several things that the government in Washington might do to deal with the problems of poverty and unemployment among Black Americans. I would like you to tell me if you favor or oppose them. a. Giving business and industry special tax breaks for locating in largely black areas.
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  blkcol
#' 
#' Question 408. Here are several things that the government in Washington might do to deal with the problems of poverty and unemployment among Black Americans. I would like you to tell me if you favor or oppose them. c. Provide special college scholarships for black children who maintain good grades.
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  racquota
#' 
#' Question 408. Here are several things that the government in Washington might do to deal with the problems of poverty and unemployment among Black Americans. I would like you to tell me if you favor or oppose them. d. Forbidding the use of racial quotas in hiring and employment.
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  influasn
#' 
#' Question 409. Some people think that certain groups have too much influence in American life and politics, while other people feel that certain groups don't have as much influence as they deserve. On this card are three statements about how much influence a group might have. For each group I read to you, just tell me the number of the statement that best says how you feel. d. Asian Americans
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  influhsp
#' 
#' Question 409. Some people think that certain groups have too much influence in American life and politics, while other people feel that certain groups don't have as much influence as they deserve. On this card are three statements about how much influence a group might have. For each group I read to you, just tell me the number of the statement that best says how you feel. e. Hispanic Americans
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
