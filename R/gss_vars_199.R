...
#' B. It is the responsibility of government to require businesses to provide consumers with the information they need to make informed choices.
#' 
#' 
#' @section Values: 
#' 
...
#'
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/1872/vshow).
#'
#' Counts by year: 
#'
...
#' 
#' Question How much do you agree or disagree with the following statements:
#' C. Natural environments that support scarce or endangered species should be left alone, no matter how great the economic benefits to your community from developing them commercially might be.
#' 
#' 
#' @section Values: 
#' 
...
#'
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/1873/vshow).
#'
#' Counts by year: 
#'
#'  |year  |iap   |agree somewhat |agree strongly |disagree somewhat |disagree strongly |don't know |no answer |not available in this year |Total |
...
#'  tagsales
#' 
#' Question How frequently do you go to garage sales, tag sales, or yard sales -- that is, one-time sales in which homeowners sell items that they no longer need from out of their homes, yards, or garages?
#' 
#' 
#' @section Values: 
#' 
...
#'
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/1874/vshow).
#'
#' Counts by year: 
#'
...
#'  haggle
#' 
#' Question When you go to such a sale, and when prices are posted, do you expect to pay the posted price, or do you expect to negotiate for a lower price?
#' 
#' 
#' @section Values: 
#' 
...
#'
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/1875/vshow).
#'
#' Counts by year: 
#'
...
#'  wkfambiz
#' 
#' Question Do you work for pay in a farm or other business owned in whole or in substantial part by a member or members of your family (parents, grandparents, children, brothers, sisters, aunts, uncles, or first cousins)?
#' 
#' 
#' @section Values: 
#' 
...
#'
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/1876/vshow).
#'
#' Counts by year: 
#'
...
#'
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/1877/vshow).
#'
#' Counts by year: 
#'
...
#'
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/1878/vshow).
#'
#' Counts by year: 
#'
...
#'  econsys
#' 
#' Question On the whole, do you think our economic system is...
#' 
#' 
#' @section Values: 
#' 
...
#'
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/1879/vshow).
#'
#' Counts by year: 
#'
...
#'  famfinan
#' 
#' Question Now I''d like to ask you about how you and your (husband/wife) organize your finances. Which of the following comes closest to describing the system that you and your (husband/wife) use:
#' 
#' 
#' @section Values: 
#' 
...
#'
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/1880/vshow).
#'
#' Counts by year: 
#'
...
#' A. Deciding whether or not to buy an automobile.
#' 
#' 
#' @section Values: 
#' 
...
#'
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/1881/vshow).
#'
#' Counts by year: 
#'
