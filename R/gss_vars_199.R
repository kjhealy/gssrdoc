...
#' Counts by year: 
#'
#'  |year  |iap   |almost every weekend |never |no answer |occasionally 1-3 times a yr |rarely |regularly |Total |
#'  |:-----|:-----|:--------------------|:-----|:---------|:---------------------------|:------|:---------|:-----|
#'  |1972  |1613  |-                    |-     |-         |-                           |-      |-         |1613  |
#'  |1973  |1504  |-                    |-     |-         |-                           |-      |-         |1504  |
#'  |1974  |1484  |-                    |-     |-         |-                           |-      |-         |1484  |
...
#'  |2021  |4032  |-                    |-     |-         |-                           |-      |-         |4032  |
#'  |2022  |3544  |-                    |-     |-         |-                           |-      |-         |3544  |
#'  |Total |70946 |56                   |457   |6         |382                         |397    |146       |72390 |
#' 
#' @section Values: 
#' 
#'   * `1` never
...
#' Counts by year: 
#'
#'  |year  |iap   |don't know |expect to pay posted price |negotiate for lower price |no answer |Total |
#'  |:-----|:-----|:----------|:--------------------------|:-------------------------|:---------|:-----|
#'  |1972  |1613  |-          |-                          |-                         |-         |1613  |
#'  |1973  |1504  |-          |-                          |-                         |-         |1504  |
#'  |1974  |1484  |-          |-                          |-                         |-         |1484  |
...
#'  |2021  |4032  |-          |-                          |-                         |-         |4032  |
#'  |2022  |3544  |-          |-                          |-                         |-         |3544  |
#'  |Total |71403 |12         |383                        |579                       |13        |72390 |
#' 
#' @section Values: 
#' 
...
#' Counts by year: 
#'
#'  |year  |iap   |between 10 and 30 hours a week |less than 10 hours a week |more than 30 hours a week |no answer |only especially busy seasons |Total |
#'  |:-----|:-----|:------------------------------|:-------------------------|:-------------------------|:---------|:----------------------------|:-----|
#'  |1972  |1613  |-                              |-                         |-                         |-         |-                            |1613  |
#'  |1973  |1504  |-                              |-                         |-                         |-         |-                            |1504  |
#'  |1974  |1484  |-                              |-                         |-                         |-         |-                            |1484  |
...
#' Counts by year: 
#'
#'  |year  |iap   |construction |don't know |farming |finance, insrnce or real est |manufacturing |no answer |other specify |retail sales |services |transportation |wholesale sales |Total |
#'  |:-----|:-----|:------------|:----------|:-------|:----------------------------|:-------------|:---------|:-------------|:------------|:--------|:--------------|:---------------|:-----|
#'  |1972  |1613  |-            |-          |-       |-                            |-             |-         |-             |-            |-        |-              |-               |1613  |
#'  |1973  |1504  |-            |-          |-       |-                            |-             |-         |-             |-            |-        |-              |-               |1504  |
#'  |1974  |1484  |-            |-          |-       |-                            |-             |-         |-             |-            |-        |-              |-               |1484  |
...
#'  |2021  |4032  |-            |-          |-       |-                            |-             |-         |-             |-            |-        |-              |-               |4032  |
#'  |2022  |3544  |-            |-          |-       |-                            |-             |-         |-             |-            |-        |-              |-               |3544  |
#'  |Total |72327 |9            |1          |6       |1                            |4             |11        |8             |6            |11       |5              |1               |72390 |
#' 
#' @section Values: 
#' 
#'   * `1` manufacturing
...
#' Counts by year: 
#'
#'  |year  |iap   |don't know |need fundamental changes |need to be replaced |no answer |ok but need some tinkering |the best possible |Total |
#'  |:-----|:-----|:----------|:------------------------|:-------------------|:---------|:--------------------------|:-----------------|:-----|
#'  |1972  |1613  |-          |-                        |-                   |-         |-                          |-                 |1613  |
#'  |1973  |1504  |-          |-                        |-                   |-         |-                          |-                 |1504  |
#'  |1974  |1484  |-          |-                        |-                   |-         |-                          |-                 |1484  |
...
#'  |2021  |4032  |-          |-                        |-                   |-         |-                          |-                 |4032  |
#'  |2022  |3544  |-          |-                        |-                   |-         |-                          |-                 |3544  |
#'  |Total |70946 |43         |537                      |113                 |8         |639                        |104               |72390 |
#' 
#' @section Values: 
#' 
#'   * `1` the best possible
...
#' Counts by year: 
#'
#'  |year  |iap   |all the money is pooled |husband manages all the money |keep finances completely separate |no answer |some of the money is pooled |wife has a housekeeping allowance |wife manages all the money |Total |
#'  |:-----|:-----|:-----------------------|:-----------------------------|:---------------------------------|:---------|:---------------------------|:---------------------------------|:--------------------------|:-----|
#'  |1972  |1613  |-                       |-                             |-                                 |-         |-                           |-                                 |-                          |1613  |
#'  |1973  |1504  |-                       |-                             |-                                 |-         |-                           |-                                 |-                          |1504  |
#'  |1974  |1484  |-                       |-                             |-                                 |-         |-                           |-                                 |-                          |1484  |
...
#'  |2021  |4032  |-                       |-                             |-                                 |-         |-                           |-                                 |-                          |4032  |
#'  |2022  |3544  |-                       |-                             |-                                 |-         |-                           |-                                 |-                          |3544  |
#'  |Total |71682 |260                     |61                            |32                                |5         |91                          |59                                |200                        |72390 |
#' 
#' @section Values: 
#' 
...
#' Counts by year: 
#'
#'  |year  |iap   |husband after consulting with wife |husband alone |husband and wife together |no answer |other |see codebook |wife after consulting husband |wife alone |Total |
#'  |:-----|:-----|:----------------------------------|:-------------|:-------------------------|:---------|:-----|:------------|:-----------------------------|:----------|:-----|
#'  |1972  |1613  |-                                  |-             |-                         |-         |-     |-            |-                             |-          |1613  |
#'  |1973  |1504  |-                                  |-             |-                         |-         |-     |-            |-                             |-          |1504  |
#'  |1974  |1484  |-                                  |-             |-                         |-         |-     |-            |-                             |-          |1484  |
...
#'  |2021  |4032  |-                                  |-             |-                         |-         |-     |-            |-                             |-          |4032  |
#'  |2022  |3544  |-                                  |-             |-                         |-         |-     |-            |-                             |-          |3544  |
#'  |Total |71682 |90                                 |47            |501                       |3         |5     |19           |22                            |21         |72390 |
#' 
#' @section Values: 
#' 
#'   * `1` husband alone
...
#'  |2021  |4032  |-                                  |-             |-                         |-         |-     |-            |-                             |-          |4032  |
#'  |2022  |3544  |-                                  |-             |-                         |-         |-     |-            |-                             |-          |3544  |
#'  |Total |71682 |22                                 |6             |471                       |5         |5     |44           |94                            |61         |72390 |
#' 
#' @section Values: 
#' 
#'   * `1` husband alone
...
#'  |2021  |4032  |-                                  |-             |-                         |-         |-     |-            |-                             |-          |4032  |
#'  |2022  |3544  |-                                  |-             |-                         |-         |-     |-            |-                             |-          |3544  |
#'  |Total |71682 |29                                 |29            |475                       |6         |15    |56           |45                            |53         |72390 |
#' 
#' @section Values: 
#' 
#'   * `1` husband alone
