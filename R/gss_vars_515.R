...
#'  volwkoth
#' 
#' Question 1403. Have you done any voluntary activity in the past 12 months in any of the following areas? Voluntary activity is unpaid work, not just belonging to an organization or group. It should be of service or benefit to other people or the community and not only to one's family or personal friends. During the last 12 months did you do volunteer work in any of the following areas: d. Any other kind of voluntary activities
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  reltruth
#' 
#' Question 1404. Which of the following statements come closest to your own views: 1. There is very little truth in any religion 2. There are basic truths in many religions 3. There is truth in one religion
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  carright
#' 
#' Question 1405. Suppose you were riding in a car driven by a close friend. You know he is going too fast. He hits a pedestrian. He asks you to tell the police that he was obeying the speed limit. a. Which statement comes closest to your belief about what your friend has a right to expect from you? 1. My friend has a definite right as a friend to expect me to testify that he was obeying the speed limit. 2. My friend has some right as a friend to expect me to testify that he was obeying the speed limit. 3. My friend has no right as a friend to expect me to testify that he was obeying the speed limit
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  cardo
#' 
#' Question 1405. Suppose you were riding in a car driven by a close friend. You know he is going too fast. He hits a pedestrian. He asks you to tell the police that he was obeying the speed limit. b. What would you do in this situation? 1. Definitely tell the police that your friend was going faster than the speed limit. 2. Probably tell the police that your friend was going faster than the speed limit. 3. Probably tell the police that your friend was not going faster than the speed limit. 4. Definitely tell the police that your friend was not going faster than the speed limit
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
