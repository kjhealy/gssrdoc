...
#'  comphome
#' 
#' Question A. Do you have one or more computers at your home? (INTERVIEWER: INCLUDE LAPTOPS THAT R CAN USE AT WORK OR HOME)
#' 
#' 
#' @section Values: 
#' 
...
#' 
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/2549/vshow).
#'
#' Counts by year: 
#'
...
#'  |2022  |-     |-   |-         |-    |3544                       |3544  |
#'  |2024  |-     |-   |-         |-    |3309                       |3309  |
#'  |Total |66413 |416 |42        |1975 |6853                       |75699 |
#'
...
#'  usehome
#' 
#' Question B. Do you, yourself, ever use a computer at home?
#' 
#' 
#' @section Values: 
#' 
...
#' 
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/2550/vshow).
#'
#' Counts by year: 
#'
#'  |year  |iap   |no |no answer |yes |not available in this year |Total |
...
#'  |2022  |-     |-  |-         |-   |3544                       |3544  |
#'  |2024  |-     |-  |-         |-   |3309                       |3309  |
#'  |Total |68432 |15 |23        |376 |6853                       |75699 |
#'
#' @source General Social Survey https://gss.norc.org
#' @family Information Society
#' @family Computers And Internet
...
#'  numhome
#' 
#' Question C. How many computers in working condition do you have in your home?
#' 
#' 
#' @section Values: 
#' 
...
#' 
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/2551/vshow).
#'
#' Counts by year: 
#'
...
#'  wwwhome
#' 
#' Question A. Can you use the World Wide Web when you are at home?
#' 
#' 
#' @section Values: 
#' 
...
#' 
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/2552/vshow).
#'
#' Counts by year: 
#'
#'  |year  |iap   |no  |no answer |yes |not available in this year |Total |
...
#'  paywww
#' 
#' Question B. Does your employer provide all or part of your Internet access from home?
#' 
#' 
#' @section Values: 
#' 
...
#' 
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/2553/vshow).
#'
#' Counts by year: 
#'
...
#'  wwwline1
#' 
#' Question C. At your home are you connected to the World Wide Web through a regular telephone line connected to your computer, or through some other means?
#' 
#' 
#' @section Values: 
#' 
...
#' 
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/2554/vshow).
#'
#' Counts by year: 
#'
...
#'  wwwline2
#' 
#' Question D. What is this other means by which you are connected to the World Wide Web?
#' 
#' 
#' @section Values: 
#' 
...
#' 
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/2555/vshow).
#'
#' Counts by year: 
#'
...
#' A. Shopping, paying bills and other household management? 
#' 1. Minutes per week?
#' 
#' 
#' @section Values: 
...
#' 
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/2556/vshow).
#'
#' Counts by year: 
#'
...
#' 
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/2557/vshow).
#'
#' Counts by year: 
#'
...
#' 
#' @section Overview: 
#' For further details see the [GSS Data Explorer page for this variable](https://gssdataexplorer.norc.org/variables/2558/vshow).
#'
#' Counts by year: 
#'
