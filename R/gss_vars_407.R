...
#'  disabld6
#' 
#' Question Because of a physical, mental, or emotional condition lasting 3 months or longer, do you have difficulty doing any of the following… Learning, remembering or concentrating?
#' 
#' 
#' @section Values: 
#'
