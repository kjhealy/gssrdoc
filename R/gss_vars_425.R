...
#'  meetf2f2
#' 
#' Question How often do you meet face-to-face with co-workers to work on projects, for example solving special problems or improving products or services? is it….
#' 
#' 
#' @section Values: 
#'
