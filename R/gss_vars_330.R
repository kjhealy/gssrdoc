...
#'  adpsymed
#' 
#' Question 948a. If the psychiatrist said your child should be on medication, how likely would you be to do that?
#' 
#' @section Overview: 
...
#'  adhos
#' 
#' Question 949. If (John/Mary) was your child, would you... Check your child into a hospital?
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  adhosmed
#' 
#' Question 949a. If hospital staff said your child should be on medication, how likely would you be to do that?
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  forcedoc
#' 
#' Question 950a. Do you think that parents of children like (John/Mary) should be forced by law to have (John/Mary) treated at a clinic or by a doctor?
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  forcemed
#' 
#' Question 950b. Do you think that parents of children like (John/Mary) should be forced by law to take a prescription medication to control (his/her) behavior?
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  forcehos
#' 
#' Question 950c. Do you think that parents of children like (John/Mary) should be forced bylaw to admit (John/Mary) to a hospital for treatment?
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  grwingup
#' 
#' Question 951. In your opinion, how likely is it that (John/Mary) is experiencing part of the normal ups and downs of growing up -- very likely, somewhat likely, not very likely, or not at all likely?
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  mntlill
#' 
#' Question 951b. In your opinion, how likely is it that (John/Mary) is experiencing a mental illness?
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  illphys
#' 
#' Question 951c. In your opinion, how likely is it that (John/Mary) is experiencing a physical illness?
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  violpeop
#' 
#' Question 952a. How likely in your opinion is it (John/Mary) would do something violent toward other people -- is it very likely, somewhat likely, not very likely, or not at all likely?
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
