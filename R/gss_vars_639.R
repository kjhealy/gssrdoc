...
#' Counts by year: 
#'
#'  |year  |iap   |don't know |first law |neither (phone mode only: volunteered) |second law |skipped on web |no answer |Total |
#'  |:-----|:-----|:----------|:---------|:--------------------------------------|:----------|:--------------|:---------|:-----|
#'  |1972  |1613  |-          |-         |-                                      |-          |-              |-         |1613  |
#'  |1973  |1504  |-          |-         |-                                      |-          |-              |-         |1504  |
#'  |1974  |1484  |-          |-         |-                                      |-          |-              |-         |1484  |
...
#'  |2016  |2867  |-          |-         |-                                      |-          |-              |-         |2867  |
#'  |2018  |2348  |-          |-         |-                                      |-          |-              |-         |2348  |
#'  |2021  |2045  |2          |353       |9                                      |1600       |23             |-         |4032  |
...
#' Counts by year: 
#'
#'  |year  |iap   |don't know |hard work most important |hard work, luck equally important (phone mode only: volunteered |luck most important |skipped on web |Total |
#'  |:-----|:-----|:----------|:------------------------|:---------------------------------------------------------------|:-------------------|:--------------|:-----|
#'  |1972  |1613  |-          |-                        |-                                                               |-                   |-              |1613  |
#'  |1973  |1504  |-          |-                        |-                                                               |-                   |-              |1504  |
#'  |1974  |1484  |-          |-                        |-                                                               |-                   |-              |1484  |
...
#'  |2016  |2867  |-          |-      |-              |-         |-              |-                                         |2867  |
#'  |2018  |2348  |-          |-      |-              |-         |-              |-                                         |2348  |
#'  |2021  |2689  |10         |824    |432            |1         |56             |20                                        |4032  |
...
#' Counts by year: 
#'
#'  |year  |iap   |depends (phone mode only: volunteered) |don't know |looking out for themselves |skipped on web |try to be helpful |Total |
#'  |:-----|:-----|:--------------------------------------|:----------|:--------------------------|:--------------|:-----------------|:-----|
#'  |1972  |1613  |-                                      |-          |-                          |-              |-                 |1613  |
#'  |1973  |1504  |-                                      |-          |-                          |-              |-                 |1504  |
#'  |1974  |1484  |-                                      |-          |-                          |-              |-                 |1484  |
...
#'  |2016  |2867  |-                                      |-          |-                          |-              |-                 |2867  |
#'  |2018  |2348  |-                                      |-          |-                          |-              |-                 |2348  |
#'  |2021  |2719  |6                                      |2          |550                        |4              |751               |4032  |
#'  |2022  |2962  |-                                      |-          |275                        |4              |303               |3544  |
...
#' Counts by year: 
#'
#'  |year  |iap   |depends (phone mode only: volunteered) |skipped on web |would take advantage of you |would try to be fair |Total |
#'  |:-----|:-----|:--------------------------------------|:--------------|:---------------------------|:--------------------|:-----|
#'  |1972  |1613  |-                                      |-              |-                           |-                    |1613  |
#'  |1973  |1504  |-                                      |-              |-                           |-                    |1504  |
#'  |1974  |1484  |-                                      |-              |-                           |-                    |1484  |
...
#'  |2016  |2867  |-                                      |-              |-                           |-                    |2867  |
#'  |2018  |2348  |-                                      |-              |-                           |-                    |2348  |
#'  |2021  |3363  |2                                      |4              |274                         |389                  |4032  |
#'  |2022  |2962  |2                                      |6              |318                         |256                  |3544  |
...
#'  |2016  |2867  |-                    |-                                     |-                          |-              |2867  |
#'  |2018  |2348  |-                    |-                                     |-                          |-              |2348  |
#'  |2021  |2719  |776                  |4                                     |527                        |6              |4032  |
#'  |2022  |2962  |383                  |1                                     |195                        |3              |3544  |
...
#' Counts by year: 
#'
#'  |year  |iap   |a bad idea |a good idea |depends (phone mode only: volunteered) |don't know |no answer |skipped on web |not available in this year |Total |
#'  |:-----|:-----|:----------|:-----------|:--------------------------------------|:----------|:---------|:--------------|:--------------------------|:-----|
#'  |1972  |1613  |-          |-           |-                                      |-          |-         |-              |-                          |1613  |
#'  |1973  |1504  |-          |-           |-                                      |-          |-         |-              |-                          |1504  |
#'  |1974  |1484  |-          |-           |-                                      |-          |-         |-              |-                          |1484  |
...
#'  |2016  |2867  |-          |-           |-                                      |-          |-         |-              |-                          |2867  |
#'  |2018  |2348  |-          |-           |-                                      |-          |-         |-              |-                          |2348  |
#'  |2021  |2719  |401        |863         |30                                     |3          |1         |15             |-                          |4032  |
#'  |2022  |2945  |202        |387         |-                                      |-          |-         |10             |-                          |3544  |
#'  |2024  |-     |-          |-           |-                                      |-          |-         |-              |3309                       |3309  |
