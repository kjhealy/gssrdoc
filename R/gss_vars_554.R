...
#'  evidu
#' 
#' Question Have you ever, even once, taken any drugs by injection with a needle (like heroin, cocaine, amphetamines, or steroids). Do not include anything you took under a doctor's orders.
#' 
#' 
#' @section Values: 
#'
