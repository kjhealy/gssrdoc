...
#' Counts by year: 
#'
#'  |year  |iap   |male |female |no answer |other |not available in this year |Total |
#'  |:-----|:-----|:----|:------|:---------|:-----|:--------------------------|:-----|
...
#'  |Total |66993 |382  |402    |11        |1     |0                          |67789 |
#'
...
#'  |2021  |3914  |18      |3       |21       |4         |69            |1         |-          |2              |-                          |4032  |
#'  |2022  |3510  |6       |1       |7        |3         |17            |-         |-          |-              |-                          |3544  |
#'  |Total |67064 |150     |64      |107      |53        |296           |46        |7          |2              |0                          |67789 |
#'
#' @source General Social Survey https://gss.norc.org
#' @family Household Members and Structure
#' @family Family
...
#' Counts by year: 
#'
#'  |year  |iap   |another household |other, don't know |no answer |traveling |institution |not available in this year |Total |
#'  |:-----|:-----|:-----------------|:-----------------|:---------|:---------|:-----------|:--------------------------|:-----|
#'  |1975  |1484  |6                 |-                 |-         |-         |-           |-                          |1490  |
#'  |1976  |1498  |1                 |-                 |-         |-         |-           |-                          |1499  |
#'  |1977  |1529  |1                 |-                 |-         |-         |-           |-                          |1530  |
...
#'  |Total |63660 |71                |7                 |7         |3         |9           |4032                       |67789 |
#'
#' @source General Social Survey https://gss.norc.org
#' @family Household Members and Structure
#' @family Family
...
#' Counts by year: 
#'
#'  |year  |iap   |child (natural, adopted, step) |son-/daughter-in-law |grand/great-grandchild |parent/parent-in-law |other relative |non-relative |no answer |spouse |not available in this year |Total |
#'  |:-----|:-----|:------------------------------|:--------------------|:----------------------|:--------------------|:--------------|:------------|:---------|:------|:--------------------------|:-----|
...
#'  |2018  |2343  |-                              |-                    |-                      |2                    |-              |3            |-         |-      |-                          |2348  |
#'  |2021  |4010  |8                              |2                    |3                      |-                    |4              |5            |-         |-      |-                          |4032  |
#'  |2022  |3541  |1                              |-                    |-                      |-                    |-              |2            |-         |-      |-                          |3544  |
#'  |Total |67594 |42                             |17                   |32                     |23                   |30             |38           |12        |1      |0                          |67789 |
#'
#' @source General Social Survey https://gss.norc.org
#' @family Household Members and Structure
#' @family Cohabitation
...
#' Counts by year: 
#'
#'  |year  |iap   |married |divorced |never married |separated |no answer |widowed |not available in this year |Total |
#'  |:-----|:-----|:-------|:--------|:-------------|:---------|:---------|:-------|:--------------------------|:-----|
...
#'  |2021  |4016  |3       |4        |9             |-         |-         |-       |-                          |4032  |
#'  |2022  |3542  |-       |1        |1             |-         |-         |-       |-                          |3544  |
#'  |Total |67663 |62      |9        |39            |5         |9         |2       |0                          |67789 |
#'
#' @source General Social Survey https://gss.norc.org
#' @family Household Members and Structure
#' @family Family
