...
#' Counts by year: 
#'
#'  |year  |iap  |administrative unit |public, 4-year or above |private not-for-profit, 4-year or above |private for-profit, 4-year or above |public, 2-year |private not-for-profit, 2-year or less |private for-profit, 2-year |private for-profit, less than 2-year |skipped on web |not available in this year |Total |
#'  |:-----|:----|:-------------------|:-----------------------|:---------------------------------------|:-----------------------------------|:--------------|:--------------------------------------|:--------------------------|:------------------------------------|:--------------|:--------------------------|:-----|
#'  |2012  |1346 |1                   |325                     |183                                     |8                                   |97             |4                                      |4                          |6                                    |-              |-                          |1974  |
#'  |2014  |1748 |-                   |432                     |242                                     |23                                  |90             |2                                      |1                          |-                                    |-              |-                          |2538  |
#'  |2016  |1936 |-                   |538                     |269                                     |15                                  |100            |-                                      |2                          |-                                    |7              |-                          |2867  |
#'  |2018  |2348 |-                   |-                       |-                                       |-                                   |-              |-                                      |-                          |-                                    |-              |-                          |2348  |
#'  |Total |7378 |1                   |1295                    |694                                     |46                                  |287            |6                                      |7                          |6                                    |7              |0                          |9727  |
#'
...
#'  |2018  |2348 |-       |-        |-           |-         |-                          |2348  |
#'  |Total |7783 |241     |624      |1065        |14        |0                          |9727  |
#'
#' @source General Social Survey https://gss.norc.org
#' @family Core
#' 
...
#' Counts by year: 
#'
#'  |year  |iap  |0-.210 graduate student per undergraduate student |.211 or over |no answer |not available in this year |Total |
#'  |:-----|:----|:-------------------------------------------------|:------------|:---------|:--------------------------|:-----|
#'  |2012  |1494 |161                                               |316          |3         |-                          |1974  |
#'  |2014  |1898 |230                                               |406          |4         |-                          |2538  |
#'  |2016  |2109 |248                                               |503          |7         |-                          |2867  |
#'  |2018  |2348 |-                                                 |-            |-         |-                          |2348  |
#'  |Total |7849 |639                                               |1225         |14        |0                          |9727  |
#'
#' @source General Social Survey https://gss.norc.org
#' @family Core
#' 
...
#'  |2018  |2348 |-           |-           |-                |-                                                                 |-                  |-                      |-                                      |-     |-            |-                  |-          |-                                                      |-                         |-        |-                         |-                                                     |-                             |-                  |-             |-                          |-     |-         |-          |-                                                  |-                          |2348  |
#'  |Total |8460 |2           |13          |25               |158                                                               |6                  |5                      |77                                     |7     |35           |597                |8          |33                                                     |5                         |11       |39                        |52                                                    |12                            |4                  |8             |29                         |69    |5         |37         |30                                                 |0                          |9727  |
#'
#' @source General Social Survey https://gss.norc.org
#' @family Core
#' @family Education
...
#'  |2018  |2348 |-           |-                |-                                                                 |-                      |-                                      |-            |-                  |-                                                      |-                         |-        |-                         |-                                                     |-                             |-                  |-             |-                          |-     |-          |-                  |-     |-           |-          |-                                                  |-                          |2348  |
#'  |Total |8845 |29          |16               |150                                                               |7                      |34                                     |23           |399                |33                                                     |6                         |10       |48                        |12                                                    |5                             |3                  |5             |14                         |29    |25         |4                  |9     |1           |1          |19                                                 |0                          |9727  |
#'
#' @source General Social Survey https://gss.norc.org
#' @family Core
#' @family Education
...
#' Counts by year: 
#'
#'  |year  |iap  |public, 4-year or above |private not-for-profit, 4-year or above |private for-profit, 4-year or above |public, 2-year |administrative unit |private for-profit, 2-year |not available in this year |Total |
#'  |:-----|:----|:-----------------------|:---------------------------------------|:-----------------------------------|:--------------|:-------------------|:--------------------------|:--------------------------|:-----|
#'  |2012  |1706 |156                     |79                                      |4                                   |29             |-                   |-                          |-                          |1974  |
#'  |2014  |2119 |243                     |129                                     |10                                  |33             |2                   |2                          |-                          |2538  |
#'  |2016  |2459 |241                     |124                                     |6                                   |37             |-                   |-                          |-                          |2867  |
#'  |2018  |2348 |-                       |-                                       |-                                   |-              |-                   |-                          |-                          |2348  |
#'  |Total |8632 |640                     |332                                     |20                                  |99             |2                   |2                          |0                          |9727  |
#'
#' @source General Social Survey https://gss.norc.org
#' @family Core
#' 
