...
#'  mtsport2
#' 
#' Question 1027f. Does the sports group meet in this area?
#' 
#' @section Overview: 
...
#'  mtyouth1
#' 
#' Question 1027g. Does the youth group meet in this area?
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
