...
#' Counts by year: 
#'
#'  |year  |iap |in-person |by phone |don't know |no answer |web  |multimode |Total |
#'  |:-----|:---|:---------|:--------|:----------|:---------|:----|:---------|:-----|
#'  |2004  |-   |2219      |593      |-          |-         |-    |-         |2812  |
#'  |2006  |-   |4209      |301      |-          |-         |-    |-         |4510  |
#'  |2008  |-   |1778      |245      |-          |-         |-    |-         |2023  |
...
#'  |2024  |-   |1174      |254      |-          |-         |1762 |119       |3309  |
#'  |Total |0   |21447     |3312     |1          |34        |6959 |248       |32001 |
#'
#' @source General Social Survey https://gss.norc.org
#' @family Paradata
#' @family Interview
...
#' Counts by year: 
#'
#'  |year  |iap  |r consents to recording interview |r consents to participate in the survey, but does not want to be recorded |no answer |not available in this release |Total |
#'  |:-----|:----|:---------------------------------|:-------------------------------------------------------------------------|:---------|:-----------------------------|:-----|
...
#'  |2022  |2695 |849                               |-                                                                         |-         |-                             |3544  |
#'  |Total |5017 |14527                             |1824                                                                      |2         |0                             |21370 |
#'
#' @source General Social Survey https://gss.norc.org
#' @family Paradata
#' @family Interview
...
#' Counts by year: 
#'
#'  |year  |iap |r consents to possible data linkage |r does not consent to possible data linkage |no answer |skipped on web |not available in this release |Total |
#'  |:-----|:---|:-----------------------------------|:-------------------------------------------|:---------|:--------------|:-----------------------------|:-----|
#'  |2018  |-   |1250                                |1089                                        |9         |-              |-                             |2348  |
#'  |2021  |549 |1532                                |1951                                        |-         |-              |-                             |4032  |
#'  |2022  |77  |1660                                |1762                                        |-         |45             |-                             |3544  |
#'  |Total |626 |4442                                |4802                                        |9         |45             |0                             |9924  |
#'
#' @source General Social Survey https://gss.norc.org
#' 
#' 
