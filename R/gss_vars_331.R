...
#'  violself
#' 
#' Question 952b. How likely in your opinion is it (John/Mary) would do something violent to (him/her)self?
#' 
#' @section Overview: 
...
#'  outsider
#' 
#' Question 953. That was my last question about (John/Mary). Now, I have some questions about children, but not about (John/Mary). Please tell me whether you Strongly Agree, Agree Somewhat, Disagree Somewhat or Strongly Disagree with the following statements: a. Getting mental health treatment for a child would make him/her an outsider at school.
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  sufadult
#' 
#' Question 953. That was my last question about (John/Mary). Now, I have some questions about children, but not about (John/Mary). Please tell me whether you Strongly Agree, Agree Somewhat, Disagree Somewhat or Strongly Disagree with the following statements: b. A child would suffer as an adult if others learn that he or she received mental health treatment when young.
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  comknows
#' 
#' Question 953. That was my last question about (John/Mary). Now, I have some questions about children, but not about (John/Mary). Please tell me whether you Strongly Agree, Agree Somewhat, Disagree Somewhat or Strongly Disagree with the following statements: c. Regardless of laws protecting confidentiality, most people in the community still know which children have had mental health treatment.
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  failure
#' 
#' Question 953. That was my last question about (John/Mary). Now, I have some questions about children, but not about (John/Mary). Please tell me whether you Strongly Agree, Agree Somewhat, Disagree Somewhat or Strongly Disagree with the following statements: d. Getting mental health treatment for a child would make a parent feel like a failure.
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  ovrmedkd
#' 
#' Question 954. Now, I'd like to ask you for your opinions on several issues. For each question, please tell me if you strongly agree, agree somewhat, disagree somewhat or strongly disagree with the statement. a. Doctors today are over-medicating children with common behavior problems.
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  medkdneg
#' 
#' Question 954. Now, I'd like to ask you for your opinions on several issues. For each question, please tell me if you strongly agree, agree somewhat, disagree somewhat or strongly disagree with the statement. b. Giving medications to children with behavior problems will have long-term negative effects on their development.
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  putsoff
#' 
#' Question 954. Now, I'd like to ask you for your opinions on several issues. For each question, please tell me if you strongly agree, agree somewhat, disagree somewhat or strongly disagree with the statement. c. Giving children psychiatric medications when they are young only puts off dealing with their real problems.
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
...
#'  trbllaw
#' 
#' Question 954. Now, I'd like to ask you for your opinions on several issues. For each question, please tell me if you strongly agree, agree somewhat, disagree somewhat or strongly disagree with the statement. d. Children who receive medical treatment for behavior problems are less likely to get into trouble with the law later in life.
#' 
#' @section Overview: 
#' For further details see the [official GSS documentation](https://gss.norc.org/get-documentation).
#'
