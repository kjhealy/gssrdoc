...
#' Counts by year: 
#'
#'  |year  |iap   |1  |2  |3  |4   |5   |6   |7   |8   |9  |don't know |most intense |no answer |weakest |not available in this year |Total |
#'  |:-----|:-----|:--|:--|:--|:---|:---|:---|:---|:---|:--|:----------|:------------|:---------|:-------|:--------------------------|:-----|
#'  |1972  |1613  |-  |-  |-  |-   |-   |-   |-   |-   |-  |-          |-            |-         |-       |-                          |1613  |
#'  |1973  |1504  |-  |-  |-  |-   |-   |-   |-   |-   |-  |-          |-            |-         |-       |-                          |1504  |
#'  |1974  |1484  |-  |-  |-  |-   |-   |-   |-   |-   |-  |-          |-            |-         |-       |-                          |1484  |
...
#' Counts by year: 
#'
#'  |year  |iap   |all that day |felt continuously |hours |minutes |no answer |seconds |several days, or |not available in this year |Total |
#'  |:-----|:-----|:------------|:-----------------|:-----|:-------|:---------|:-------|:----------------|:--------------------------|:-----|
#'  |1972  |1613  |-            |-                 |-     |-       |-         |-       |-                |-                          |1613  |
#'  |1973  |1504  |-            |-                 |-     |-       |-         |-       |-                |-                          |1504  |
#'  |1974  |1484  |-            |-                 |-     |-       |-         |-       |-                |-                          |1484  |
...
#' Counts by year: 
#'
#'  |year  |iap   |every once in a while |just once or twice |never-not once until now |no answer |very often |not available in this year |Total |
#'  |:-----|:-----|:---------------------|:------------------|:------------------------|:---------|:----------|:--------------------------|:-----|
#'  |1972  |1613  |-                     |-                  |-                        |-         |-          |-                          |1613  |
#'  |1973  |1504  |-                     |-                  |-                        |-         |-          |-                          |1504  |
#'  |1974  |1484  |-                     |-                  |-                        |-         |-          |-                          |1484  |
