...
#'  coisco08
#' 
#' Question Respondent's partner's occupation, 2010 census, and 2008 ISCO code
#' 
#' 
#' @section Values: 
#' 
...
#'  sei
#' 
#' Question Respondent socioeconomic index.
#' 
#' 
#' @section Values: 
#' 
...
#'  firstsei
#' 
#' Question Socioeconomic index of respondentâ€™s first occupation.
#' 
#' 
#' @section Values: 
#' 
...
#'  pasei
#' 
#' Question Socioeconomic index of respondent's father.
#' 
#' 
#' @section Values: 
#' 
...
#'  masei
#' 
#' Question Socioeconomic index of respondent's mother.
#' 
#' 
#' @section Values: 
#' 
...
#'  spsei
#' 
#' Question Socioeconomic index of respondent's spouse.
#' 
#' 
#' @section Values: 
#' 
...
#'  sei10
#' 
#' Question SEI10 is based on the 2010 Census occupation classification. It is estimated from 539 occupational categories, using PRESTG105PLUS.
#' 
#' 
#' @section Values: 
#' 
...
#'  sei10educ
#' 
#' Question Percentage of those who had some college or more education among those who had the same occupation as in OCC10 in American Community Survey between 2010 and 2012 (25-64 years old only). This percentage is not from the GSS but it is used to calculate SEI10.
#' 
#' 
#' @section Values: 
#' 
...
#'  sei10inc
#' 
#' Question Percentage of those who earned $45,000 or more among those who had the same occupation as in OCC10 in American Community Survey between 2010 and 2012 (25-64 years old only).This percentage is not from the GSS but it is used to calculate SEI10.
#' 
#' 
#' @section Values: 
#' 
...
#'  pasei10
#' 
#' Question PASEI10 is based on the 2010 Census occupation classification. It is estimated from 539 occupational categories, using PAPRES105PLUS.
#' 
#' 
#' @section Values: 
#' 
